...
WsAutoFarRightKick3CrossFNF::WsAutoFarRightKick3CrossFNF()
{
}
...
void WsAutoFarRightKick3CrossFNF::initParams(void)
{
    ...
    rev2.kickerRange = WsKickerRange::KICKER_RANGE_NEAR;
