#include "WsAutoFarRightKick3Score.h"


WsAutoFarRightKick3Score::WsAutoFarRightKick3Score()
{
}
...
void WsAutoFarRightKick3Score::initParams(void)
{
    ...
    setRangeFar.kickerLoft = WsKickerLoft::KICKER_LOFT_LOW;
    ...
    rev2.kickerLoft = WsKickerLoft::KICKER_LOFT_LOW;
    ...
    reload2.kickerLoft = WsKickerLoft::KICKER_LOFT_LOW;
    ...
    rev3.kickerRange = WsKickerRange::KICKER_RANGE_FAR;
    rev3.kickerLoft = WsKickerLoft::KICKER_LOFT_LOW;
